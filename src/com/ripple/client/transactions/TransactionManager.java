...
public class TransactionManager {
    ...
    public TransactionManager(Client client, AccountRoot accountRoot, AccountID accountID, KeyPair keyPair) {
        this.client = client;
    ...
    private Request makeSubmitRequest(final Transaction transaction) {
        ...
        req.json("tx_blob", Hex.toHexString(transaction.tx_blob));
