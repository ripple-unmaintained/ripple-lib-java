...
public class Seed {
    ...
    public static KeyPair createKeyPair(byte[] seedBytes) {
        BigInteger secret, pub, privateGen, modSubPrime = SECP256K1.sjclCurveR();
        ...
        publicGenBytes = gMultBy(privateGen);
        ...
        pub = Utils.uBigInt(gMultBy(secret));
    ...
    private static byte[] gMultBy(BigInteger secret) {
        return SECP256K1.getG().multiply(secret).getEncoded(true);
    }
