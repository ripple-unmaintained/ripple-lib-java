...
public class STObject implements SerializedType, Iterable<Field> {
    ...
    public String toHex() {
        return Hex.toHexString(translate.toWireBytes(this)).toUpperCase();
    }
...
//                        throw new RuntimeException("Unknown message " + key);
    ...
    public abstract static class STObjectField extends STObject implements HasField {
    }
    ...
    public void put(Field f, Object value) {
        ...
        try {
            value1 = (SerializedType) typeTranslator.fromValue(value);
        } catch (Exception e) {
