...
public class KeyPairTest {
    ...
    public void testDerivationFromString() {
        IKeyPair keyPairFromSeed = Seed.createKeyPairFromSeedString(TestFixtures.master_seed);
...
//    @Test
    public void testRippleLibGarbage() throws Exception {
        ...
        IKeyPair kp = Seed.createKeyPairFromSeedBytes(Seed.passPhraseToSeedBytes("root"));
