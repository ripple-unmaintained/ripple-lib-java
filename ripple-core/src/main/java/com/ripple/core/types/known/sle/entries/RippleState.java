...
public class RippleState extends ThreadedLedgerEntry {
    ...
    * */
    ...
    public Hash256[] directoryIndexes() {
        Vector256 hashes = new Vector256();

//        if (flags().testBit(LedgerFlag.LowReserve)) {
//            hashes.add(lowNodeOwnerDirectory());
//        }
//        if (flags().testBit(LedgerFlag.HighReserve)) {
//            hashes.add(lowNodeOwnerDirectory());
//        }
//        Hash256[] ret = new Hash256[hashes.size()];
