...
public class TransactionTest {
    ...
    public void testTransactionIDCreation2() throws Exception {
        ...
        Hash256 expected = Hash256.translate.fromString("78794CD91D01F144FBEBE3ECB0690B159E04829CE576B75B7E8ABF8B8FA7DD97");
        STObject tx = STObject.fromJSONObject(new JSONObject(tx_json));
        Hash256 rehashed = Hash256.transactionID(STObject.translate.toWireBytes(tx));
    ...
    public void testSerializationAndSigning() throws Exception {
        ...
        assertEquals("63641BEDC50E9D2C1519042E78CFB53354DE94144ED67ED8C1F05A3621219209", reHash.toString().toUpperCase());
    }
}
